	...
	: m_pTexture(nullptr)
{
	...
	GetAnimator()->LoadAnimation(L"animation\\BackGround\\SwampUnder.anim");
}
...
void CSwampUnder::start()
{
}

void CSwampUnder::update()
{
	GetAnimator()->PlayL(L"SwampUnder", true);
}

void CSwampUnder::render(HDC _dc)
{
