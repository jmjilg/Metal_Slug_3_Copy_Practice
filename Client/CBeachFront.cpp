	...
	: m_pTexture(nullptr)
{
	...
	GetAnimator()->LoadAnimation(L"animation\\BackGround\\BeachFront.anim");
}
...
void CBeachFront::start()
{
}

void CBeachFront::update()
{
	GetAnimator()->PlayL(L"BeachFront", true);
}

void CBeachFront::render(HDC _dc)
{
